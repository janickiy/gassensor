            ...
            <div class="my-row">
                <div>
                    ...
                    <ul class="topbar-left">
                        <li><a target="_blank" onclick="ym(85084891,'reachGoal','CLICK_ON_ADRESS')"
                               href="https://yandex.ru/maps/-/CCQ~aVhHlD">
                                <i class="icon ion-md-pin"></i><?= Setting::getAdress() ?>
                            </a></li>
                        <li><a onclick="ym(85084891,'reachGoal','CLICK_ON_PHONE')"
                               href="tel:+<?= Setting::getPhoneOnlyNumber() ?>"><i
                                        class="icon ion-md-call"></i><?= Setting::getPhone() ?></a></li>
                        <li><a onclick="ym(85084891,'reachGoal','CLICK_ON_PHONE')"
                               href="tel:+<?= Setting::getPhoneOnlyNumber2() ?>"><i
                                        class="icon ion-md-call"></i><?= Setting::getPhone2() ?></a></li>
                        <li><a href="mailto:<?= Setting::getEmail() ?>"><i
                                        class="icon ion-md-mail"></i><?= Setting::getEmail() ?></a></li>
                    </ul>
                </div>
                        ...
                        <li class="toggle_search topbar-search">
                            <form action="/search">
                                <div class="d-flex">
                                    ...
                                    <button class="pt-1 ms-1 bg-transparent border-0"><i class="icon ion-md-search"></i>
                                    </button>
                                </div>
                            </form>
                        </li>
    ...
    <div id="sky">
        ...
        <div class="logo-block">
            <div class="logo-brand">
                <a href="/">
                    <img src="/i/logo.svg" loading="lazy" alt="Газсенсор: ГАЗОВЫЕ ДАТЧИКИ И СЕНСОРЫ"
                         title="Газсенсор: ГАЗОВЫЕ ДАТЧИКИ И СЕНСОРЫ">
                </a>
            </div>
        </div>
