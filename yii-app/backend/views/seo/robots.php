...
$this->title = Yii::t('app', 'Редактирование: Robots.txt', [
    'name' => 'Редактирование: Robots.txt',
]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Seo'), 'url' => ['index']];
$this->params['breadcrumbs'][] = Yii::t('app', 'Robots.txt');
        ...
        <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false">
            ...
            <div>
                ...
                <div class="widget-body">
                    ...
                    <?= Html::beginForm(Url::to(['seo/update-robots']), 'post'); ?>

                    <div class="form-group">
                        <?= Html::label('robots', 'content', ['class' => 'control-label']) ?>
